...
func AddLargeAsteroid(ecs *ecs.ECS, x, y float64, view *utility.View, doCount bool) *donburi.Entity {
    entity := ecs.Create(
        layer.Foreground, 
        component.Position, 
    ...
    collider.Hitboxes = append(collider.Hitboxes, component.NewHitbox(14, 0, 0))
    ...
    *wrap.Distance = 16.0
    ...
    am[component.Destroy_actionid] = func() {
        event.ScoreEvent.Publish(ecs.World, event.Score{Value:2})
