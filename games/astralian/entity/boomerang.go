...
func AddBoomerang(ecs *ecs.ECS, pX, pY float64, velocity math.Vec2, view *utility.View, audioContext *audio.Context) *donburi.Entity {
    entity := ecs.Create(
        layer.Foreground, 
        component.Position, 
    ...
    cdm[component.SelfDestruct_actionid] = component.Cooldown{Cur:200, Max:200}
